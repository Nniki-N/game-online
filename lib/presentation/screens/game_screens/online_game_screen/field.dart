...
class Field extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final GameFieldTheme gameFieldTheme = Theme.of(context).extension<GameFieldTheme>()!;
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: gameFieldTheme.backgroundColor,
                  borderRadius: gameFieldTheme.borderRadius,
                ),
              ...
              Positioned(
                ...
                child: Container(
                  height: fieldSize,
                  width: fieldSpacing,
                  color: gameFieldTheme.separatorColor,
                ),
              ),
              Positioned(
                top: 0,
